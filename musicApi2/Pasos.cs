namespace musicApi
{
    public class Pasos
    {
         ...
         * 3. Instalar EntityFrameworkCore.SqlServer ✔
         * 4. Instalar EntityFrameworkCore.Tools ✔
         * 5. Instalar AutoMapper ✔
         * 6. Instalar swagger ✔
         * 7. Crear carpeta Models ✔
         * 8. Crear los modelos ✔
         * 9. Crear el contexto en la carpeta Services ✔
         * 10. Crear la connection string en appsettings.json ✔
         * 11. Inyectar el contexto en el program.cs ✔
         ...
         *      Dentro de cada servicio voy a implementar los metodos de la interfaz IEntityInterface, y voy a definir
