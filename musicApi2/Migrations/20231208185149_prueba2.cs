    ...
    public partial class prueba2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistsReleases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArtistsReleases_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ArtistsReleases_Releases_ReleaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_Releases_ReleaseId",
                        column: x => x.ReleaseId,
                        principalTable: "Releases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistsReleases_ArtistId",
                table: "ArtistsReleases",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtistsReleases_ReleaseId",
                table: "ArtistsReleases",
                column: "ReleaseId");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_ReleaseId",
                table: "Ratings",
                column: "ReleaseId");
